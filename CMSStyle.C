...
void CMSStyle(){
  ...
  gStyle->SetTitleOffset(0.9,"xy");  // bring y axis label closer to narrow values
  ...
  cmsStyle->SetLabelSize(0.06,"x");
  cmsStyle->SetTitleSize(0.07,"x");
  cmsStyle->SetLabelSize(0.06,"y");
  cmsStyle->SetTitleSize(0.07,"y");
  cmsStyle->SetLabelSize(0.06,"z");
  cmsStyle->SetTitleSize(0.07,"z");
